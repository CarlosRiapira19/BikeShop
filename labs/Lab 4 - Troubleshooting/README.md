...
- Stop the app by pressing `Ctrl + C` in the terminal, or by clicking on the 'Stop' button in the debugger panel.
...
- Open GitHub Copilot Chat, click **+** to clear prompt history, then ask the following question:
    ...
    **Note:**
    Take into note that after copying the prompt above, #file and #terminalSelection will not create the proper addition file to the context. You will need to erase that and write it again with typing **#BikeShopController.cs** and **#terminalSelection**
...
- Ask the following question in GitHub Copilot Chat in the **Ask** mode:
...
### Step 4: Reviewing Changes with MCP (Model-Context-Protocol) and Context Menu

Now that you have made changes to your codebase, it's essential to review those changes to ensure correctness and understand what was modified. GitHub Copilot provides built-in review features, including the MCP (Model-Context-Protocol) for reviewing changes and a context menu review option.

#### Goal

Learn how to review your recent code changes using the context menu and MCP (Model-Context-Protocol) in GitHub Copilot Chat.

#### Review from Context Menu

- In your code editor, right-click somewhere next to the code where you made changes
- From the context menu, select **Copilot > Review and Comment**
- Select **BikeShopController.cs**
- The Copilot Chat will open a review panel summarizing your recent changes.  

![Controller Docs](../../img/lab1step7-1.png)
![Controller Docs](../../img/lab1step7-2.png)
![Controller Docs](../../img/lab1step7-3.png)

#### Review Using MCP (Built-In -> Changes)

- Turn on Agent mode in Copilot Chat:

![Controller Docs](../../img/lab1step7-4.png)

- Verify if Built-in > Changes are enabled:

![Controller Docs](../../img/lab1step7-5.png)
![Controller Docs](../../img/lab1step7-6.png)

- Let's add a new code, but with an error to demonstrate how Copilot will review the code with it. Open **Bike.cs** from **src/BikeShopAPI/Entities** folder and add **BikeTypeId**:
...
namespace BikeShopAPI.Entities
{
  public class Bike
  {
     ...
     public virtual BikeType? BikeType { get; set; } // this should throw an error
  }
}
```

- You can now trigger a review via Copilot Chat in the Agent mode using a prompt. Click "+" to open a new chat in Copilot Chat and type prompt:

#### Prompt Example

```text
Let's review my latest changes
```

![Controller Docs](../../img/lab1step7-7.png)

Copilot will analyze your recent changes and provide a summary, explanations, or even feedback on possible improvements.

- Click continue to continue the review process:

![Controller Docs](../../img/lab1step7-8.png)

- After clicking "continue" again Copilot will display **Code Review Summary** with **Changes**, **Issues**, **Recommendations**, **Design Pattern Observations** and **Next Steps**:

![Controller Docs](../../img/lab1step7-9.png)

![Controller Docs](../../img/lab1step7-10.png)

As you can see Copilot even proposed a help to fix the detected issue.
Now we can go to Source Code and remove changes made in **Bike.cs**

---

**Summary:**
Reviewing your code changes is a crucial step in the development workflow. GitHub Copilot Chat and its built-in panels make this process intuitive and efficient. Practice using both the context menu and MCP to get comfortable with reviewing your work, and don't hesitate to use prompts to ask Copilot for help reviewing your latest changes.
