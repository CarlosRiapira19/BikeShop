...
> 3. Remember, GitHub Copilot is a tool designed to assist you, but it doesn’t replace the need for a thorough understanding of your code and regular testing and debugging practices. We look forward to exploring this exciting tool with you during the workshop!

---

> [!CAUTION]
> To ensure a consistent and trouble-free setup for everyone, **all participants are required to use GitHub Codespaces for the hands-on portions of this workshop**. This guarantees that everyone will have the same development environment, configuration, and tools, regardless of their local machine.
> We do not recommend using local development environments for this workshop, as troubleshooting local configuration issues will not be supported. Please make sure you have access to GitHub Codespaces before the workshop begins.

---

> [!TIP]
> If you would like try out it locally (without using GitHub Codespaces), please skip `Lab 0`.
>
